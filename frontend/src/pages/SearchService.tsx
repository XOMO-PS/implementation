            ...
            <div className="flex ">
              <div className="flex-1 pr-4 pt-3 mt-32 mr-3">
                <table className="table-fixed table border-none py-9">
                  <caption className="caption-top bg-cyan-50">
                    Providers
                  </caption>
              ...
              <div className="flex border hover:border-darkGreen rounded-2xl">
                ...
                <div className="flex-1 p-4">
                  <label className="form-control w-full max-w-xs mb-4">
                    ...
                    <Input inputSize="small" value="Full names" disabled />
                  </label>
                  <label className="form-control w-full max-w-xs mb-4">
                    <div className="label">
                      <span className="label-text">Location</span>
                    </div>
                    <Input inputSize="small" value="Bremen" disabled />
                  </label>
                  <label className="form-control w-full max-w-xs mt-4">
                    <div className="label">
                      <span className="label-text">Company</span>
                    </div>
                    <Input inputSize="small" value="Company" disabled />
                  </label>
                  <label className="form-control w-full max-w-xs">
                    <div className="label">
                      <span className="label-text">Position</span>
                    </div>
                    <Input inputSize="small" value="Position" disabled />
                  </label>
